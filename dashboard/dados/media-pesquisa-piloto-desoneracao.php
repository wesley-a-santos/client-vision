...
$Query = "SELECT COUNT(PesquisaID) AS Quantidade, "
        . "SUM(CASE WHEN [Desoneracao] = 1 THEN 1 ELSE 0 END) AS QuantidadeOnerados, "
        . "SUM(CASE WHEN [Desoneracao] = 0 THEN 1 ELSE 0 END) AS QuantidadeDesonerados "
...
//    $Retorno[] = ['Dados' => $Valores['Quantidade'], 'Rotulos' => 'Total de Consultas' ];
    $Retorno[] = ['Dados' => $Valores['QuantidadeOnerados'], 'Rotulos' => 'Consultas que Geraram chamado' ];
    $Retorno[] = ['Dados' => $Valores['QuantidadeDesonerados'], 'Rotulos' => 'Consultas que Não Geraram chamado' ];    
}
