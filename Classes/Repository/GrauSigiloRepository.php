...
class GrauSigiloRepository extends EntityRepository {
    ...
    {
        return ValidarArray::retornarArray($this->getEntityManager()->getRepository(GrauSigilo::class)->findAll());
    }

    public function findAll()
    {
        return $this->findBy(array(), array('GrauSigilo' => 'ASC'));
    }
