...
/**
 * Description of TipoInformacaoRepository
 *
 * @author Wesley Alves da Silva Santos <wesley.a.santos@caixa.gov.br em http://www.cemob.sp.caixa/>
 */
class TipoInformacaoRepository extends EntityRepository {
    ...
    public function listar(): array {
        return ValidarArray::retornarArray($this->getEntityManager()->getRepository(TipoInformacao::class)->findAll());
    }
