...
/**
 * Description of StatusDemandaRepository
 *
 * @author Wesley Alves da Silva Santos <wesley.a.santos@caixa.gov.br em http://www.cemob.sp.caixa/>
 */
class StatusDemandaRepository extends EntityRepository {
    ...
    {
        return ValidarArray::retornarArray($this->getEntityManager()->getRepository(StatusDemanda::class)->findAll());
    }

    public function findAll()
    {
        return $this->findBy(array(), array('Status' => 'ASC'));
    }
